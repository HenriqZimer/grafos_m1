...
# -*- coding: utf-8 -*-
"""
Demonstração específica com slides_modificado.txt
"""
...
def main():
    arquivo = "data/slides_modificado.txt"
    nome_arquivo = "slides_modificado.txt"
    ...
    print("\n🎉 TESTE COM SLIDES_MODIFICADO.TXT FINALIZADO!")
